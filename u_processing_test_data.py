...
def get_label(allData_sets):
    ...
    for set in allData_sets: # set is all data for 1 test storm
...
def test_saver(AllFiles, AllFilesNoNA, configData): 
    ...
    test = []
    test_dir_I = 'C:/Users/UserAdmin/Documents/PythonWork/dbdt_MKII_u/Input_Label_I/all_test/'
    test_dir_II = 'C:/Users/UserAdmin/Documents/PythonWork/dbdt_MKII_u/Input_Label_I/filtered_test/'
    num = 0
