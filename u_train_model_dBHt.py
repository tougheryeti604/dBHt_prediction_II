...
We are predicting a continuous variable (dBHt percentage). Regression should be used 
...
def optimise(train_Dataset, train_dirs):   
    ...
    num_epoch = 50 # It is the number of times the model trains over the whole dataset
    batch_size = 1000
    dataset_size = 100000
    ...
    for epoch in range(num_epoch): # Train our model for the given of epochs 
        ...
        for batch in dataloader: # For every batch of data in our DataLoader 
            ...
            print("Completed batch: {0}".format(ct))
...
def test(test_Dataset, test_dirs): 
    ...
    test_model_params = torch.load('C:/Users/UserAdmin/Documents/PythonWork/dbdt_MKII_u/Input_Label_dBHt/assemble_RNN/config_6/model_v1', weights_only=False)
...
def train(train_Dataset, train_dirs): 
    ...
    torch.save(model_params, 'C:/Users/UserAdmin/Documents/PythonWork/dbdt_MKII_u/Input_Label_dBHt/assemble_RNN/config_6/model_v1')

    # Save loss values for plotting later
    loss_file = 'C:/Users/UserAdmin/Documents/PythonWork/dbdt_MKII_u/Input_Label_dBHt/assemble_RNN/config_6/loss.csv'
...
def testnsave(allTest_Dataset, all_test):
    ...
    forecast_file = 'C:/Users/UserAdmin/Documents/PythonWork/dbdt_MKII_u/Input_Label_dBHt/assemble_RNN/config_6/testforecast.pt'
    ground_truth_file = 'C:/Users/UserAdmin/Documents/PythonWork/dbdt_MKII_u/Input_Label_dBHt/assemble_RNN/config_6/groundtruth.pt'
    allDates_file = 'C:/Users/UserAdmin/Documents/PythonWork/dbdt_MKII_u/Input_Label_dBHt/assemble_RNN/config_6/testdates.csv'
